...
const STRINGS: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "campaign.sessionHistory": "Session history",
    "campaign.played": "Played",
    ...
    "session.downloadIcs": "Download .ics",
    "session.googleCalendar": "Google Calendar",
    ...
    "bulk.onlyRemaining": "Only remaining",
  ...
  it: {
    ...
    "campaign.sessionHistory": "Storico sessioni",
    "campaign.played": "Giocata",
    ...
    "session.addToCalendar": "Aggiungi al calendario",
    "session.downloadIcs": "Scarica .ics",
    "session.googleCalendar": "Google Calendar",
    ...
    "bulk.onlyRemaining": "Solo rimanenti",
